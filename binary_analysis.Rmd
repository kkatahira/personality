...
とらえるためにそれぞれの因子スコアの符号でクラス (象限) を分類し
数の分布を見るという分析法を試してみます (
この分析法は我々の[コメント論文](https://psyarxiv.com/wua9j/)に対する[リプライ論文](https://psyarxiv.com/rvpfs/)で用いられていますが，我々がコメント論文の投稿前に著者に送った原稿の中で提案していたものです)。
...
ある意味ではとらえられているといえるのですが，それでは分布の構造を理解したことにはならないと思います。)
