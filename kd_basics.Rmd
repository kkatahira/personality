...
※1　(19/9/18追記) ただし，直交回転を用いたからといって，必ずしも因子スコアの相関がゼロに近い値になるわけではありません。その点については
[こちらのページ](fa_rotation.html)で確認しています。この手法を適用する場合は，
推定された因子スコアに相関が生じていないか確認する必要があります。
相関がある場合は，白色化などの処理を行って無相関化をすることが望ましいかもしれません。
